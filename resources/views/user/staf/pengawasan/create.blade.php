...
@section('contents')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('perindag/pengawasan') }}">Data Perizinan</a></li>
    ...
    <section class="section">
        <div class="card">
            <form action="{{ url('perindag/pengawasan/createOrUpdate/' . $perizinan->id) }}" method="post"
                ...
                <div class="card-body p-3">
                    ...
                    <div class="tab-content m-3" id="myTabContent">
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="jasa"
                                        ...
                                        placeholder="Jasa Produk Apa" value="{{ old('jasa') }}">
                                    @error('jasa')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="noSurat"
                                        ...
                                        placeholder="No Surat Keterangan Domisili" value="{{ old('noSurat') }}">
                                    @error('noSurat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="bangunan"
                                        ...
                                        placeholder="Jumlah Bangunan" value="{{ old('bangunan') }}">
                                    @error('bangunan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tenaga"
                                        ...
                                        placeholder="Tenaga Kerja" value="{{ old('tenaga') }}">
                                    @error('tenaga')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <img src="{{ asset('image/default-img.png') }}" alt="" width="100%"
                                        class="me-2" height="500px" id="preview" style="background-size: cover">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody id="table1">
                                    <tr>
                                        <td><input type="text" name="fasilitas[]" class="form-control" required></td>
                                        <td><input type="text" name="kondisi[]" class="form-control" required></td>
                                        <td><input type="file" name="gambar[]" class="form-control" required></td>
                                        <td><button class="btn btn-outline-primary" type="button" id="addRow"><i
                                                    class="bi bi-plus-circle"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
