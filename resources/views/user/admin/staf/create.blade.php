...
@section('contents')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('perindag/staf') }}">User</a></li>
    ...
    <section class="section">
        <div class="card">
            <form action="{{ $user->id ? url('perindag/staf/' . $user->id) : url('perindag/staf') }}" method="post">
                @csrf
                @if ($user->id)
                    @method('PUT')
                @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="role" class="form-select @error('role') is-invalid @enderror">
                                    <option value="{{ $user->role }}">{{ $user->role == 2 ? 'Staf' : '' }}</option>
